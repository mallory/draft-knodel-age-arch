...
Prior focus on child safety has led to large user platforms to implement trust and safety measures of various levels of robustness and effectiveness.  Content and behaviour moderation have become industry standard, largely through regulatory pressure. Its phases: Define, detect, evaluate, enforce, appeal, educate. This cycle ensures that criminal and unlawful content is taken down. Platforms and services with user generated content can also use this cycle to ensure content or behavior that violates platform terms of service.
